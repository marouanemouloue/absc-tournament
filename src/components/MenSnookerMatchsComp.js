...
import "assets/css/matchs.css"
const MenSnookerMatchsComp = () => {
    const [matchinfo, setmatchinfo] = useState([]);

    useEffect(() => {
        Axios.get("http://absc-snooker.herokuapp.com/ReadMenMatches/").then((response) => {
...
// console.log(fw1)
    ...
    const columns = [
        ...
        { accessor: 'table', label: 'table_number', priorityLevel: 6, position: 6 },
    ...
    return (
        <div id="matchComp" >
            ...
            <ReactCollapsingTable rows={rows} columns={columns} showSearch={true} rowSize={300} id={true} minWidth={"0px"} />
        </div>
    )
}

export default MenSnookerMatchsComp
