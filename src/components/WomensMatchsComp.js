...
const WomensMatchsComp = () => {
    const [matchinfo, setmatchinfo] = useState([]);

    useEffect(() => {
        Axios.get("http://absc-snooker.herokuapp.com/ReadWomenMatches/").then((response) => {
...
// console.log(fw1)
    ...
    return (
        ...
        <ReactCollapsingTable rows={rows} columns={columns} showSearch={true} id={true} minWidth={"0px"} rowSize={300} />
    </div>
    )
}

export default WomensMatchsComp
